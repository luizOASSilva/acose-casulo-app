    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'type' => 'url',
                'value' => 'https://maps.google.com/maps?q=Rua+Francisco+Rodrigues+Dias,+80+Bragança+Paulista&z=15&output=embed',
                'is_public' => true,
                'sort_order' => 15,
            ],
            [
                ...
                'type' => 'url',
                'value' => 'https://www.google.com/maps?q=Rua+Francisco+Rodrigues+Dias,+80+Bragança+Paulista',
                'is_public' => true,
                'sort_order' => 16,
            ],
            [
                ...
                'type' => 'text',
                'value' => 'Centro Dia Pessoa Com Deficiência',
                'is_public' => true,
                'sort_order' => 17,
            ],
